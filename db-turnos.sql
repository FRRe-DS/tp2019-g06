...
-- -----------------------------------------------------
-- Table `turnos`.`Consultorio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `turnos`.`Consultorio` (
  `piso` INT(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `turnos`.`Turno` (
  ...
  `Consultorio_piso` INT(2) NOT NULL,
  `Consultorio_numero` INT(3) NOT NULL,
  `Medico_idMedico` INT(6) NOT NULL,
  PRIMARY KEY (`idTurno`),
  INDEX `fk_Turno_Paciente_idx` (`Paciente_idPaciente` ASC),
  INDEX `fk_Turno_Consultorio1_idx` (`Consultorio_piso` ASC, `Consultorio_numero` ASC),
  ...
  CONSTRAINT `fk_Turno_Paciente`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Turno_Consultorio1`
    FOREIGN KEY (`Consultorio_piso` , `Consultorio_numero`)
    REFERENCES `turnos`.`Consultorio` (`piso` , `numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
