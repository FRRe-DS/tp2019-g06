...
public class ObraSocialController {
	...
	/*
	 * @GetMapping("/paciente/{idPaciente}") public ResponseEntity<Set<ObraSocial>>
	 * findByPaciente(@PathVariable Integer idPaciente) { Paciente paciente =
	 * pacienteRepository.getOne(idPaciente); Set<ObraSocial> ret =
	 * repository.findByPaciente(paciente); return ResponseEntity.ok(ret); }
	 * 
	 * @GetMapping("/medico/{idMedico}") public ResponseEntity<Set<ObraSocial>>
	 * findByMedico(@PathVariable Integer idMedico) { Medico medico =
	 * medicoRepository.getOne(idMedico); Set<ObraSocial> ret =
